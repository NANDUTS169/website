...
const editProduct = async (req, res) => {
    try {
        ...
        // product.regularPrice = data.regularPrice; // Removed from form
        // product.salePrice = data.salePrice;     // Removed from form
        // product.quantity = data.quantity;       // Removed from form
